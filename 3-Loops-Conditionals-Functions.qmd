...
```{r}
if (enrollment <= 90) print (TRUE) else print("not yet")
```
...
```{r}
list_of_presidents <- (Carter, Regan, HWBush, Clinton, WBush, Obama)
if (list_of_presidents > 5) print(TRUE) else print("add more presidents")
```
