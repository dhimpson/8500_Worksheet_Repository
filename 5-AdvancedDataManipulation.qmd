...
```{r}
## not sure if you wanted BostonWomenVoters data here, it looked like it did not have a specific state column,but the gayguides did?? Getting a "unexpected symbol warning"
gayguides %>% 
  group_by(state,Year) %>%
  summarize(count n =())
```
