...
```{r}
seventies.locations <- gayguides %>% filter(Year >= 1975 & Year <= 1980)
```
...
```
## I dont think I did this right. When I look at my dataframe it says "no rows to show"...Seee notes
...
```
## I think the above worked, but I am unsure if I needed to create a new dataframe to store it??? 
