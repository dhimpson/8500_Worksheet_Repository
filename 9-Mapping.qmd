...
```
```{r}
#first tried to see the documentation for this dataset in a hope to gain a better understanding of her project.?parks did not yield documentation. I decided to begin by creating a bar chart to visualize park by country.
